...
def single_pathway_heterogeneity(adata, pathway, key, order=None, by_score=True, fontsize=10, xlab_rot=90, showfig=False, savefig=True, figname='single_pathway.pdf', format='pdf', figsize=(6,3)):
    ...
    plt.bar( np.arange(0, het.size, 1), 1-het[ind] )
